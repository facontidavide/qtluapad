...
struct qt_meta_stringdata_LuaEditor_t {
    QByteArrayData data[3];
    char stringdata0[31];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_LuaEditor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_LuaEditor_t qt_meta_stringdata_LuaEditor = {
    {
QT_MOC_LITERAL(0, 0, 9), // "LuaEditor"
QT_MOC_LITERAL(1, 10, 19), // "setDocumentModified"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "LuaEditor\0setDocumentModified\0"
};
...
void LuaEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->setDocumentModified(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject LuaEditor::staticMetaObject = {
    { &QsciScintilla::staticMetaObject, qt_meta_stringdata_LuaEditor.data,
      qt_meta_data_LuaEditor,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *LuaEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_LuaEditor.stringdata0))
